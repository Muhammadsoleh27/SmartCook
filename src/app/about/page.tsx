...
export default function SmartCookHomePage() {
  return (
    <div className="min-h-screen md:ml-[20%] m-auto md:w-[70%] mb-15 md:mb-0 w-[100%] bg-gradient-to-br from-blue-50 to-green-50 font-inter text-gray-800 antialiased">
      {/* Hero Section */}
